...
public class VentanaInsertarCliente extends Controlador{
	...
	private void insertar() {
		...
		if (tfDni.getStyleClass().contains("valido") && tfNombre.getStyleClass().contains("valido") && tfTelefono.getStyleClass().contains("valido")) {
			try {
				vistaGrafica.getControlador().insertar(new Cliente(tfNombre.getText(), tfDni.getText(), tfTelefono.getText()));
